...
const ButtonAtras = () => {
  ...
  return (
    <StyledWrapperAtras>
      <button type="button" className="btn" onClick={atras}>
        <strong>⬅️ ATRÁS</strong>
...
const StyledWrapperAtras = styled.div`
  .btn {
    display: flex;
    justify-content: center;
    align-items: center;
...
const ButtonTerminar = () => {
  const navigate = useNavigate();
      ...
      const terminar = () => {
        navigate('/Login/Usuario/Examen/Fin');
      };
  return (
    <StyledWrapperTerminar>
      <button onClick={terminar}> TERMINAR
      </button>
    </StyledWrapperTerminar>
  );
}

const StyledWrapperTerminar = styled.div`
  button {
    font-size: 18px;
    letter-spacing: 2px;
